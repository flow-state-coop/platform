...
The **Flow State platform** is the open-source Next.js application behind [flowstate.network](https://flowstate.network), the app that powers Flow QF rounds, Flow Splitters, and Flow Councils on top of [Superfluid](https://docs.superfluid.org).
