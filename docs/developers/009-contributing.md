...
All three must pass. `pnpm lint` enforces `no-unused-vars`, so a stray import will fail the build. See [Testing](008-testing.md) for the integration and end-to-end suites.
