---
slug: /flow-councils/apply
description: Applying for funding from a Flow Council
---
...
Reviewers respond with a decision—**Accepted**, **Changes Requested**, or **Rejected**—along with a review comment. Once accepted, your funding wallet is added to the round's onchain distribution pool and you start earning with your first vote; see [Receiving Funding](003-receiving-funding.md) for what comes next.
