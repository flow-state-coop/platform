export const councilAbi = [
  ...
  {
    inputs: [],
    name: "CantApproveToken",
    type: "error",
  },
  {
    inputs: [],
    name: "CantTransferToken",
    type: "error",
  },
  {
    inputs: [],
    name: "CouncilMemberAlreadyAdded",
    type: "error",
  },
  {
    inputs: [],
    name: "CouncilMemberNotFound",
    type: "error",
  },
  {
    inputs: [
  ...
  {
    inputs: [],
    name: "TotalAllocatedExceedsBalance",
    type: "error",
  },
  {
    inputs: [],
    ...
    inputs: [
      {
        indexed: false,
        internalType: "uint8",
        name: "maxAllocationsPerMember",
        type: "uint8",
      },
    ],
    name: "MaxAllocationsPerMemberSet",
    type: "event",
  },
  {
    anonymous: false,
  ...
  },
  {
    inputs: [
      {
        internalType: "uint8",
        name: "_maxAllocationsPerMember",
        type: "uint8",
      },
    ],
    name: "setMaxAllocationsPerMember",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
