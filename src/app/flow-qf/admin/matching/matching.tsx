        ...
        {!profileId || !chainId ? (
          ...
          <>
            <Card.Text className="fs-5 fw-semi-bold">
              Distribute funds to Matching Pool
            </Card.Text>
            {loading ? (
              <Spinner className="m-auto" />
            ) : (
              <Form>
                <Form.Group className="mb-4">
                  ...
                  >
                    <Form.Control
                      ...
                      value={gdaPool ?? ""}
                      disabled
                      className="rounded-4 py-4 fw-semi-bold border-4 border-dark"
                    />
                    <Button
                      variant="link"
                      href={`${network?.superfluidExplorer}/pools/${gdaPool}`}
                      target="_blank"
                      className="rounded-4 bg-secondary text-decoration-none py-4 fw-semi-bold text-light border-4"
                    >
                      View on Explorer
                    </Button>
                  </InputGroup>
                ...
                <Button
                  className="mt-4 text-light py-4 rounded-4 fw-semi-bold"
