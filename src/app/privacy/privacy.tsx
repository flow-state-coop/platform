...
export default function Privacy() {
  return (
    ...
    >
      ...
      <p className="mt-3 fs-5">High-Level Summary</p>
      <p>
      ...
      <p className="fs-5">Data We Collect</p>
      <p>
      ...
      <p className="fs-5 mt-3">How We Share Data</p>
      ...
      <p className="mt-3 fs-5">Unique Jurisdictions</p>
      ...
      <p className="fs-5 mt-3">Notice Given</p>
