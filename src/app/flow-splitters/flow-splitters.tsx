...
export default function FlowSplitters() {
            ...
            {pools.map((pool, i) => {
              ...
              return (
                <Card
                  ...
                  style={{ height: 410 }}
                >
                  <Card.Title className="mt-3 fs-3">
                          ...
                          >
                            <Card.Text className="m-0 fs-1 fw-bold">
                              {Intl.NumberFormat("en", {
                                ...
                                Number(
                                  formatEther(
                                    pool.flowRate * BigInt(SECONDS_IN_MONTH),
                                  ),
                                ),
                              )}
                            </Card.Text>
                            <Card.Text className="mt-2 mb-0 fs-6">
                              /mo
                            </Card.Text>
                          </Stack>
                        ) : (
                          <Stack direction="vertical">
                            <Card.Text className="mb-0 fs-1 fw-bold text-center">
                              {Number(pool.units)}
                            </Card.Text>
                            <Stack
                              direction="horizontal"
                            ...
                            >
                              <Card.Text className="mt-3 mb-0 small">
                                Unconnected Shares
                              </Card.Text>
                              <InfoTooltip
                                target={
                                ...
                                content={
                                  <>
                                    Complete a one-time transaction to receive
                                    your Flow Splitter stream in real-time. Your
                                    funds are safe, but static until you connect
                                    your shares.
                                  </>
                                }
                              />
                  ...
                  <Card.Footer className="d-flex flex-column gap-1 w-100 bg-transparent border-0">
                    ...
                    {pool.isConnected ? (
                      <Button
                        ...
                        onClick={() =>
                          router.push(
                            `/flow-splitters/${selectedNetwork.id}/${pool.id}`,
                          )
                        }
                      >
                        View
