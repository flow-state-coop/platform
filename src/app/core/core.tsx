...
export default function Core(props: CoreProps) {
  ...
  const { data: superfluidQueryRes, loading: superfluidQueryLoading } =
    useQuery(SUPERFLUID_QUERY, {
      ...
      variables: {
        token: pool?.token,
        flowStateSafe: "0x0d9d26375b882e0ddb38a781a40e80945e3d0b9b",
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      for (const inflow of superfluidQueryRes.account.inflows) {
        addresses.push(inflow.sender.id);
      }
      ...
      >
        ...
        !ensByAddress ? (
          ...
          <>
              ...
              <Stack direction="horizontal" gap={1}>
                ...
                {poolAdmins.find(
                  ...
                  <Button
                    ...
                    onClick={() =>
                      router.push(`/flow-splitters/${chainId}/0x3/admin`)
                    }
                  >
                    <InfoTooltip
                      position={{ top: true }}
            ...
            {ensByAddress && (
              <PoolGraph
                flowStateSafeInflows={superfluidQueryRes?.account.inflows}
