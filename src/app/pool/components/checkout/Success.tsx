      ...
      <Card className="bg-light mt-4 p-4 rounded-4 border-0">
        ...
        <Stack direction="horizontal" className="justify-content-around">
          <Card.Link
            ...
            rel="noreferrer"
            target="_blank"
            href={`https://twitter.com/intent/tweet?text=I%20opened%20a%20stream%20to%20${isFundingMatchingPool ? "the matching pool" : granteeTwitter ? granteeTwitter : granteeName}%20in%20the%20${poolName === "Octant Builder Accelerator" ? "%40OctantApp%20Builder%20Accelerator" : poolName}%20SQF%20round%20on%20%40flowstatecoop.%0A%0AI%27m%20earning%20%40Superfluid_HQ%20%24SUP%20every%20second%20for%20supporting%20public%20goods.%0A%0AYou%20can%20too%20%F0%9F%91%87%3A%20${poolUiLink}&url=https://x.com/flowstatecoop/status/1909243251246104641`}
            data-size="large"
          >
          ...
          <Card.Link
            ...
            rel="noreferrer"
            target="_blank"
            href={`https://farcaster.xyz/~/compose?text=I%20opened%20a%20stream%20to%20${isFundingMatchingPool ? "the matching pool" : granteeFarcaster ? granteeFarcaster : granteeName}%20in%20the%20${poolName === "Octant Builder Accelerator" ? "@octant%20Builder%20Accelerator" : poolName}%20SQF%20round%20on%20@flowstatecoop.%0A%0AI%27m%20earning%20@superfluid%20%24SUP%20every%20second%20for%20supporting%20public%20goods.%0A%0AYou%20can%20too%F0%9F%91%87%3A&embeds[]=https://farcaster.xyz/flowstatecoop/0x87385e01&embeds[]=${isFundingMatchingPool ? poolUiLink : framesLink}`}
          >
            <Image
              src="/farcaster.svg"
              alt="farcaster"
